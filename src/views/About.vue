<template>
    ...
    <main class="w-full h-fit font-rhd bg-[#FFF4E6]">
            ...
            <div class=" w-full h-full text-black p-[24px] md:p-[48px] flex flex-col justify-end">
                <div data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <p class="font-light text-[18px] md:text-[20px] 2xl:text-[24px] opacity-80">Get ready to satisfy
                        It all started with a simple question in 2019: "Where can I get the best Jollof?" One
                        colleague’s casual inquiry led to an answer that sparked a culinary movement. "I can make you
                        some," turned a shared love for food into what would become Oliver Twist Shack.</p>
                </div>
            ...
            <div class="flex flex-col gap-[24px]">
                ...
                <p data-aos="fade-up" data-aos-duration="1500"
                    ...
                    small idea evolved into something much greater. <span class="opacity-30">
                        ...
                        grew, and soon Oliver Twist Shack opened its doors, offering a unique mix of local and
                        continental
                ...
                <p data-aos="fade-up" data-aos-duration="1500"
                    ...
                    young orphan from Charles Dickens' classic tale, we’ve always believed in asking for more. <span
                        class="opacity-30">
                        That
                        famous scene where Oliver asks for another helping inspired our entire philosophy: more flavor,
                        more
                ...
                <p data-aos="fade-up" data-aos-duration="1500"
                    class="text-[18px] md:text-[20px] 2xl:text-[24px] font-light">But what truly sets us apart? <span
                        ...
                        offering both dine-in and
                        delivery
                        options.
                    </span> We don’t just make meals—we create experiences. <span class="opacity-30"> Every plate is
                        made with passion, care, and
                ...
                <p data-aos="fade-up" data-aos-duration="1500"
                    ...
                    new locations, we’re just getting started.</p>
        ...
        <section
            class="w-full h-screen 2xl:h-[110vh] relative before:content-[''] before:w-full before:h-full before:absolute before:bg-black before:bg-opacity-5">
            <img class="w-full h-full object-cover" src="../assets/Homepage/herosectionimg.jpg" alt="Banner Image">
        </section>
            ...
            <div data-aos="fade-up" data-aos-duration="1500"
                ...
                <div class="w-full h-fit flex flex-col gap-[24px] items-end">
                    <p class="text-[18px] md:text-[20px] 2xl:text-[24px] font-light opacity-80">Cooking at Oliver Twist
                        Shack isn't just about making
                        food—it's about creating moments. Every
                        dish I prepare carries the weight of tradition, passion, and a desire to make someone’s day just
                        a little bit better. From the first Jollof rice I served to now feeding thousands of guests,
                        each plate tells a story—of love, community, and the joy of sharing a meal. Seeing our customers
                        smile, hearing them ask for more, it reminds me why I started this journey. It’s not just food;
                        it’s my heart on a plate.</p>
                    <div class="flex gap-[16px]">
                        <div class="w-[80px] h-[80px] rounded-full overflow-hidden">
                            <img class="w-full h-full object-cover" src="../assets/About/headchef.jpg" alt="">
                        </div>
                        <div class="text-[18px]">
                            <p>Kojo Asante</p>
                            <p class="opacity-50">Head Chef</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            staffs: [
                {
                    name: 'Kojo Asante',
                    role: 'Head Chef',
                    image: new URL('../assets/About/staff1.jpg', import.meta.url).href
                },
                {
                    name: 'Baba Seidu',
                    role: 'Chef',
                    image: new URL('../assets/About/staff2.jpg', import.meta.url).href
                },
                {
                    name: 'Efua Djan',
                    role: 'Customer Service Lead',
                    image: new URL('../assets/About/staff3.jpg', import.meta.url).href
                },
                {
                    name: 'Yaw Ofori',
                    role: 'Bartender',
                    image: new URL('../assets/About/staff4.jpg', import.meta.url).href
                },
